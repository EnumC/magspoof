This is a modification of cheeseandcereal's magspoof, which is also a fork of samyk's magspoof(https://github.com/samyk/magspoof). Cheeseandcereal's magspoof fork cleans up the code a tad, and slightly changes the way that the data is sent.
This present fork is aimed to adapt the code to be fully functional for a MST alternate prototype and additional changes will be forthcoming. 
